...
#                 agent_a.update_agent(old_state, (a1_action, a2_action))
#                 agent_b.update_agent(old_state, (a1_action, a2_action))
...
#         # ===== PHASE 1: Train Random vs Random =====
#         logger.info(f"=== SIMULATION {simulation_id + 1} - PHASE 1: Training Random vs Random ===")
#         environment = Environment()
#         agent_a_random = Agent(environment, random_policy=True, is_A=True)
#         agent_b_random = Agent(environment, random_policy=True, is_A=False)
        
#         logger.info("Training is skipped for random agents as they do not learn.")
        
#         # Test 1a: Random vs Random without draws
#         environment.reset()
#         stats = self.test_agents(agent_a_random, agent_b_random, include_draws=False)
...
#         # Test 1b: Random vs Random with draws
#         environment.reset()
#         stats = self.test_agents(agent_a_random, agent_b_random, include_draws=True)
#         simulation_results.append({
#             'simulation_id': simulation_id + 1,
#             'Train_method': 'vs_random',
...
#         # Clean up phase 1
#         del agent_a_random, agent_b_random, environment
        
#         # ===== PHASE 2: Train Belief vs Random =====
#         logger.info(f"=== SIMULATION {simulation_id + 1} - PHASE 2: Training Belief vs Random ===")
#         environment = Environment()
...
#         # Test 2a: Belief A vs Random B without draws
#         environment.reset()
...
#         # Test 2b: Belief A vs Random B with draws
#         environment.reset()
...
#         # ===== PHASE 3: Train Belief vs Belief =====
#         logger.info(f"=== SIMULATION {simulation_id + 1} - PHASE 3: Training Belief vs Belief ===")
#         environment = Environment()
#         agent_a_belief = Agent(environment, random_policy=False, is_A=True)
...
#         # Test 3a: Belief vs Belief without draws
#         environment.reset()
...
#         # Test 3b: Belief A vs Random B without draws
#         environment.reset()
...
#         # Test 3c: Random A vs Belief B without draws
#         environment.reset()
...
#         # Test 3d: Belief vs Belief with draws
#         environment.reset()
...
#         # Test 3e: Belief A vs Random B with draws
#         environment.reset()
...
#         # Test 3f: Random A vs Belief B with draws
#         environment.reset()
...
#     def save_results(self, filename: str = 'results/padoan_simulations_correctorder.csv'):
